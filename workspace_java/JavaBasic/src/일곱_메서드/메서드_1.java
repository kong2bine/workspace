...
//메서드의 사용은 크게 메서드 정의부분과 메서드 호출 부분으로 나뉨.
//메서드를 사용하려면 반드시 메서드 정의 후 호출을 해야 함!

//메서드의 정의는 클랠스 안 + 다른 메서드 밖에서 선언한다.
...
//매개변수의 역할 : 메서드의 기능을 구현할 떄 필요한 데이터를 외부로 받아오는 것
...
//'return'키우드는 항상 메서드의 마지막에 딱 한 번 만 실행 가능!(작성은 여러번 가능)
//
