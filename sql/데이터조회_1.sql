...
-- 2024.6.25 3,4교시
-- 이것은 주석입니다.
-- 하이픈 다음 무조건 한 칸 띄우기! 그렇게 해야 주석처리가 됨
...
-- 커미션이 NULL인 사람의 사번, 사원명, 커미션을 조회
-- 조건에서 NULL 여부를 확인할 떄는 주의 필수!
...
SELECT * FROM emp
WHERE JOB = '사원' AND DEPTNO != 30 AND SAL <= 700;

-- 급여가 400이하거나 700이상인 사원 중
-- 직급이 과장이면서 커미션은 NULL인 직원들의
-- 사번, 사원명, 급여, 직급, 커미션을 조회
-- 단, 커미션은 ''인센티브'라는 별칭을 사용하여 조회
